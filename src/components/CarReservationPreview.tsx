...
export const CarReservationPreview: React.FC<CarReservationPreviewProps> = ({
  ...
  return (
    <div className="flex h-full w-full flex-col font-oswald gap-6 lg:flex-col-reverse">
      <span className="w-full self-center h-full max-w-[600px] max-h-[300px]">
        <img src={carItem.primaryImage} alt="" className="mx-auto w-full h-full" />
      </span>
      <div className="flex flex-col gap-6">
        <h2 className="text-2xl lg:text-3xl">{`${carItem.title} ${carItem.year}`.toUpperCase()}</h2>
